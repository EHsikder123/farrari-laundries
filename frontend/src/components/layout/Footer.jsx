...
import { businessInfo, services } from '../../data/mockData';
    ...
    <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <a
                ...
                className="bg-white text-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105 shadow-lg"
              >
                Download App
              </a>
            </div>
            <div className="flex items-center gap-4">
              <img
                src="https://images.unsplash.com/photo-1641199788912-9a7385a35c82?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzMjV8MHwxfHNlYXJjaHwzfHxkZWxpdmVyeSUyMHZhbnxlbnwwfHx8fDE3NzAwNTM1MzB8MA&ixlib=rb-4.1.0&q=85&w=150"
                alt="Delivery Van"
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* More Services */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-red-400">More Services</h3>
            <ul className="space-y-2">
